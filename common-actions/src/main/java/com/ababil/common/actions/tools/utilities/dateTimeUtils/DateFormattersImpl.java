...
public class DateFormattersImpl implements DateFormatters {
    ...
    @Override
    public String formatDateTimeAsString(String formatOutputMask, String formatInputMask, String inputDateTimeString, String outDateTimeString, String extraParam) throws Exception {
